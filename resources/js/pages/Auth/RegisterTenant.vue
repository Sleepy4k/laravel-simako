...
<template>
    <Head title="Daftar Pemilik Kost" />
    <AuthLayout>
        <div>
            <h1 class="text-xl font-bold text-slate-900 mb-1">Daftar sebagai Pemilik Kost</h1>
            <p class="text-xs text-slate-500 mb-6">Lengkapi data berikut untuk membuat akun Anda</p>
