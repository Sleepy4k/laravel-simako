    ...
    <DashboardLayout>
        <div>
            <div class="mb-6">
                ...
                <p class="text-sm text-slate-500 mt-0.5">{{ props.payments.total }} total tagihan</p>
            </div>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b border-slate-200 bg-slate-50">
                                ...
                                <th class="text-left px-5 py-3.5 font-semibold text-xs text-slate-500 uppercase tracking-wider">Bukti</th>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr v-for="payment in props.payments.data" :key="payment.id" class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-5 py-4 text-slate-500">{{ payment.proofs?.length ?? 0 }}</td>
                                <td class="px-5 py-4">
            ...
            <div v-else class="bg-white border border-slate-200 rounded-2xl p-16 text-center shadow-sm">
                <p class="text-sm font-semibold text-slate-700">Belum ada data pembayaran</p>
            </div>
